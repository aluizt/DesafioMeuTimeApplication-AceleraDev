...
public class Time {
	...
	public Time( Long id,String nome, LocalDate dataCriacao, String corUniformePrincipal,
		...
		this.jogadores = new ArrayList<Long>();
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((idCapitao == null) ? 0 : idCapitao.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (id == null) {
			...
			return false;
		if (idCapitao == null) {
			if (other.idCapitao != null)
				return false;
		} else if (!idCapitao.equals(other.idCapitao))
			return false;
		if (nome == null) {
			if (other.nome != null)
				return false;
